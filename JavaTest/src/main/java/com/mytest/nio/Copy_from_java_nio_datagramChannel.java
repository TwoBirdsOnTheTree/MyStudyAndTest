...
public class Copy_from_java_nio_datagramChannel {
    ...
    public Copy_from_java_nio_datagramChannel(String[] argv) throws Exception {
        if (argv.length == 0) {
    ...
    public static void main(String[] argv) throws Exception {
        Copy_from_java_nio_datagramChannel client =
                new Copy_from_java_nio_datagramChannel(argv);
        client.sendRequests();
        client.getReplies();
    }
} 